...
class ExchangeBetween extends _$ExchangeBetween {
  ...
  bool swap(Currency from, Currency to) {
    ...
    if (newState.from.isTime) {
      $appEvents.add(const TriedToSetFromToTimeCurrencyEvent());
      return false;
    }
  ...
  bool setNewOrder(Currency from, Currency to1, Currency? to2) {
    final newState = Between(from, to1, to2, showTo2: to2 != null);
...
final class TriedToSetFromToTimeCurrencyEvent extends AppEvent {
  const TriedToSetFromToTimeCurrencyEvent();
}
