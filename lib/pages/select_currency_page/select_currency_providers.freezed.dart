...
abstract class $SelectCurrencyStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({Currency selectingFor});
}
...
class _$SelectCurrencyStateCopyWithImpl<$Res, $Val extends SelectCurrencyState>
  ...
  @override
  $Res call({
    Object? selectingFor = null,
  }) {
    return _then(_value.copyWith(
      selectingFor: null == selectingFor
          ? _value.selectingFor
          : selectingFor // ignore: cast_nullable_to_non_nullable
              as Currency,
    ) as $Val);
  }
}
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.selectingFor, selectingFor) ||
...
abstract class _SelectCurrencyState implements SelectCurrencyState {
  factory _SelectCurrencyState({required final Currency selectingFor}) =
      _$SelectCurrencyStateImpl;
